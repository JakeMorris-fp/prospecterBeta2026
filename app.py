...
"
    ...
    with col3:
        # Increment attempts for currently filtered rows
...
', '\n')}",
            ...
            # Optionally include attendee if we have their email
        ]
...
").encode("utf-8")
    ...
    with st.container(border=True):
        ...
        # Preview for a selected contact
        ...
        # Generate all personalized emails as CSV for bulk use
